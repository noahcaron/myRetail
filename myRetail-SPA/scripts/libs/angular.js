 ...
 *
 * @example
 * Here is a simple form for editing user product information. Adding, removing, clearing, and
 ...
 *      Product:
 *      <ul>
 *        <li ng-repeat="product in settings.products">
 *          <select ng-model="product.type">
 *             <option>phone</option>
 *             <option>email</option>
 *          </select>
 *          <input type="text" ng-model="product.value"/>
 *          [ <a href="" ng-click="settings.clearProduct(product)">clear</a>
 *          | <a href="" ng-click="settings.removeProduct(product)">X</a> ]
 *        </li>
 *        <li>[ <a href="" ng-click="settings.addProduct()">add</a> ]</li>
 *     </ul>
 *    </div>
 *   </file>
 *   <file name="app.js">
 ...
 *    };
 *
 *    SettingsController1.prototype.addProduct = function() {
 *      this.products.push({type: 'email', value: 'yourname@example.org'});
 *    };
 *
 *    SettingsController1.prototype.removeProduct = function(productToRemove) {
 *     var index = this.products.indexOf(productToRemove);
 *      this.products.splice(index, 1);
 *    };
 *
 *    SettingsController1.prototype.clearProduct = function(product) {
 *      product.type = 'phone';
 *      product.value = '';
 *    };
 *   </file>
 ...
 *
 *       var firstRepeat =
 *           container.element(by.repeater('product in settings.products').row(0));
 *       var secondRepeat =
 *           container.element(by.repeater('product in settings.products').row(1));
 *
 *       expect(firstRepeat.element(by.model('product.value')).getAttribute('value'))
 *           .toBe('408 555 1212');
 *
 *       expect(secondRepeat.element(by.model('product.value')).getAttribute('value'))
 ...
 *
 *       expect(container.element(by.repeater('product in settings.products').row(2))
 ...
 *         </select>
 *         <input type="text" ng-model="product.value"/>
 *         [ <a href="" ng-click="clearProduct(product)">clear</a>
 *         | <a href="" ng-click="removeProduct(product)">X</a> ]
 *       </li>
 *       <li>[ <a href="" ng-click="addProduct()">add</a> ]</li>
 *    </ul>
 *   </div>
 *  </file>
 *  <file name="app.js">
 ...
 *       $scope.products.push({type:'email', value:'yourname@example.org'});
 *     };
 *
 ...
 *
 *      var firstRepeat =
 *          container.element(by.repeater('product in products').row(0));
 *      var secondRepeat =
 *          container.element(by.repeater('product in products').row(1));
 *
 *      expect(firstRepeat.element(by.model('product.value')).getAttribute('value'))
 *          .toBe('408 555 1212');
 *      expect(secondRepeat.element(by.model('product.value')).getAttribute('value'))
 ...
 *      container.element(by.linkText('add')).click();
 *
 *      expect(container.element(by.repeater('product in products').row(2))
 *          .element(by.model('product.value'))
 *          .getAttribute('value'))
 *          .toBe('yourname@example.org');
 *    });
